...
# antigen bundle z # 超级好用的shell路径快速跳转工具，比autojump更轻量更快，而且就一个字母多省事 https://github.com/rupa/z
# antigen bundle command-not-found # provide suggested packages to be installed if a command cannot be found
